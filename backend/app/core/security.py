...
def hash_reset_token(token: str) -> str:
    ...
    here would spend CPU defending against a dictionary attack that cannot
    apply. This is the value that goes in the database; the token itself is
    shown once to whoever issued it and lives only in the link they pass on.
    """
